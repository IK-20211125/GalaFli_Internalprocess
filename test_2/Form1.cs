...
namespace test_2
{
    public partial class Form1 : Form
    {
        ...
        public void Json_Load(test_2.Data jsonDataTemp)
        {
            try
            {
        ...
        public void Send(Key key)
        {
            ...
            //currentState（現在の画面）を basisState（デフォルトの画面）で上書き
            currentState = basisState;
